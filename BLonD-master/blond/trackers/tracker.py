...
class RingAndRFTracker:
    ...
    def __init__(self, RFStation, Beam, acceleration_type, solver='simple', BeamFeedback=None,
        ...
        #if self.acceleration_type='RF'
        #    self.acceleration_kick = - RFStation.delta_E
        #elif self.acceleration_type='IND'
        #    self.acceleration_kick = 0
