...
def plot_several_bunch_length_evol(turns,
    ...
    if show_plot:
        ...
        fign = dirname +'/jump_several_bunch_length_evol.png'
        plt.savefig(fign)
    plt.clf()
...
def plot_several_plot_emittance_evol(turns,
    ...
    if show_plot:
        ...
        fign = dirname +'/jump_several_bunch_emittance.png'
        plt.savefig(fign)
    plt.clf()
...
def plot_several_bunch_energy_spread_evol(turns,
    ...
    if show_plot:
        ...
        fign = dirname +'/jump_several_bunch_energy_spread.png'
        plt.savefig(fign)
    plt.clf()


# DIFFERENT MCF AND MODELS, WO JUMP, WO SC
h5file1 = '/Users/Bell/GIT_REPOS/Protvino/BLonD-master/__EXAMPLES/output_files/U-70_jump_6.9-12.9(simple)/U-70_jump.h5'
h5file2 = '/Users/Bell/GIT_REPOS/Protvino/BLonD-master/__EXAMPLES/output_files/U-70_jump_6.9-12.9(exact)/U-70_jump.h5'
h5file3 = '/Users/Bell/GIT_REPOS/Protvino/BLonD-master/__EXAMPLES/output_files/U-70_jump_6.9-12.9_MCF(exact)/U-70_jump.h5'
label1='All Jump, simple, first-order'
label2='exact, first-order'
label3='exact, second-order'

# DIFFERENT MCF, WO JUMP, SC, INTENCITY
h5file4 = '/Users/Bell/GIT_REPOS/Protvino/BLonD-master/__EXAMPLES/output_files/U-70_jump_6.9-8.9_MCF_+10(exact)/U-70_jump.h5'
h5file5 = '/Users/Bell/GIT_REPOS/Protvino/BLonD-master/__EXAMPLES/output_files/U-70_jump_6.9-8.9_MCF_+10_int(exact)/U-70_jump.h5'
h5file6 = '/Users/Bell/GIT_REPOS/Protvino/BLonD-master/__EXAMPLES/output_files/U-70_jump_6.9-8.9_MCF_-10(exact)/U-70_jump.h5'
h5file7 = '/Users/Bell/GIT_REPOS/Protvino/BLonD-master/__EXAMPLES/output_files/U-70_jump_6.9-8.9_MCF_-10_int(exact)/U-70_jump.h5'

label4='exact, second-order, Z=+10i'
label5='exact, second-order, Z=+10i, int'
label6='exact, second-order, Z=-10i'
label7='exact, second-order, Z=-10i, int'
